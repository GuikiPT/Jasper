...
export class SupportThreadReminderButtonHandler extends InteractionHandler {
	...
	public override parse(interaction: ButtonInteraction) {
		try {
			...
			this.container.logger.error('Failed to parse support thread reminder button interaction', error, {
	...
	public override async run(interaction: ButtonInteraction, data: ReminderButtonMetadata) {
		try {
			...
			this.container.logger.error('Failed to process support thread reminder button interaction', error, {
